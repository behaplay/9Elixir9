...
const Bacground = () => {
    return (
        <section className="m-auto bg-cover bg-[url('https://prium.github.io/elixir/v3.0.0/assets/img/background-15.jpg')] w-[100%] h-[1050px] lg:h-[700px] sm:px-[20px] py-[150px] md:p-[150px] flex flex-col gap-20">
            <div className="flex flex-row gap-4">
                <img src="https://prium.github.io/elixir/v3.0.0/assets/img/checkmark.png" className="mt-3 w-[55px] h-[55px]" alt="" />
                <div className="flex flex-col">
                    <h2 className="text-[43px] md:text-[50px] font-bold text-aran">Take the right step,</h2>
                    <h2 className="text-[43px] md:text-[50px] font-bold text-gray-500">do the big things.</h2>
                </div>
            </div>
            <div className="flex flex-col md:flex-row gap-16 sm:gap-24 ml-16 flex-wrap text-gray-600 md:text-siniy">
