    ...
    return (
        <section className="bg-siniy py-[80px] flex flex-col lg:flex-row justify-center items-center gap-10 mt-32 m-auto">
            ...
            <div className='px-3'>
               ...
               <form>
                <div className="w-[100%] md:w-[728px] flex flex-col gap-4">
                    ...
                    <div className="flex flex-row gap-4">
                        ...
                        <input type="submit" value='Sabmit' className="wek w-[100%] md:w-[332px] h-[45.2px] font-semibold text-[14px] bg-aran border-[1px] border-aran rounded-sm active:bg-[white] active:text-[black] active:border-[1px] active:border-black cursor-pointer hover:opacity-80" />
                    </div>
                </div>
               </form>
            </div>
