    ...
    return (
        <section className="m-auto flex flex-row lg:justify-between md:justify-center gap-10 flex-wrap container px-5 lg:px-20 mt-10">
            <div className="flex flex-col">
                ...
                <p className="text-[16px] text-gray-600 w-[80%] md:w-[280px]">Before talking destination, we shine a spotlight across your organization
            ...
            <div className="flex flex-col">
                ...
                <p className="text-[16px] text-gray-600 w-[80%] md:w-[320px]">If you face any trouble, you can always let our dedicated support team help you. They are ready for you 24/7.</p>
            </div>
            <div className="flex flex-col">
                <div className="flex flex-row items-center gap-2">
                ...
                <p className="text-[16px] text-gray-600 w-[80%] md:w-[288px]">We develop a systematic well-ordered process of analysis, from concept through implementation.</p>
            </div>
        </section>
    )
}
