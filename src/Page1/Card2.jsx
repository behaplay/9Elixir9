...
const Card2 = () => {
    return (
        <section className="m-auto flex flex-row gap-8 justify-center flex-wrap mt-20 px-2">
            <div className="w-[100%] h-[615px] md:w-[379px] md:h-[525px]  rounded-b-2xl flex flex-col gap-3 shadow-md hover:shadow-lg">
            ...
            <div className="w-[100%px] h-[615px] md:w-[379px] md:h-[525px]  rounded-b-2xl flex flex-col gap-3 shadow-md hover:shadow-lg">
